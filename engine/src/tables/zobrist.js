...
export const ZOBRIST_SEEDS = {
  pieces: [
    [
      // side 0, piece type 0 (King) - 64 entries
      [
      ...
      // side 0, piece type 1 (Queen) - 64 entries
      [
      ...
      // side 0, piece type 2 (Rook) - 64 entries
      [
      ...
      // side 0, piece type 3 (Bishop) - 64 entries
      [
      ...
      // side 0, piece type 4 (Knight) - 64 entries
      [
      ...
      // side 0, piece type 5 (Pawn) - 64 entries
      [
    ...
    [
      // side 1, piece type 0 (King) - 64 entries
      [
      ...
      // side 1, piece type 1 (Queen) - 64 entries
      [
      ...
      // side 1, piece type 2 (Rook) - 64 entries
      [
      ...
      // side 1, piece type 3 (Bishop) - 64 entries
      [
      ...
      // side 1, piece type 4 (Knight) - 64 entries
      [
      ...
      // side 1, piece type 5 (Pawn) - 64 entries
      [
  ...
  // 2 entries for side to move
  sides: [0x575bae22c55bf622n, 0x546dd47aeec56881n],

  // 17 entries for en passant (0-7: files for white ep, 8-15: files for black ep, 16: no ep)
  enPassant: [
...
// Export named references for easier access
export const PIECE_SQUARE_KEYS = ZOBRIST_SEEDS.pieces;
export const CASTLING_KEYS = ZOBRIST_SEEDS.castling;
...
/**
 * Get the en passant Zobrist index for incremental updates
 */
export function getEnPassantZobristIndex(enPassantSq) {
  if (enPassantSq === -1) return 16;

  const file = enPassantSq % 8;
  const rank = Math.floor(enPassantSq / 8);

  if (rank === 2) return file;       // White pawn (0-7)
  if (rank === 5) return 8 + file;   // Black pawn (8-15)
